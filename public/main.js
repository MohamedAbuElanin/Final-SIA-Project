...
function updateAuthUI(user) {
    ...
    if (user) {
        ...
        const authContent = `
            ...
            <button onclick="handleLogout()" class="btn-nav btn-nav--signup">Logout</button>
        `;
        
        if (navAuth) navAuth.innerHTML = authContent;
        if (drawerAuth) drawerAuth.innerHTML = authContent;
    } else {
        // User is logged out - Show Sign In & Sign Up
        const authContent = `
            <a href="./sign in/signin.html" class="btn-nav btn-nav--signin">Sign In</a>
            <a href="./sign up/signup.html" class="btn-nav btn-nav--signup">Sign Up</a>
        `;
